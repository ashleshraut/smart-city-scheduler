"""
jobs.py - Central job definitions for Smart City Monitoring Platform.

PCB Fields (stored/maintained in Process Control Block):
  - job_id: Process Identifier (PID)
  - priority: Process scheduling priority level

Simulation-only Metadata (used for workload generation and evaluation):
  - zone: Geographic originating region
  - arrival_time: Simulation clock time when process becomes ready
  - burst_time: CPU execution duration required
"""
